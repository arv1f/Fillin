...
export const DEFAULT_SCENE_TITLES: Record<SceneId, string> = {
  '00': 'Вход',
  '01': 'Таймлайн. Этапы становления энергетической системы России.',
  '02': 'Второй Этап',
  '03': 'Третий Этап',
  '04': 'Четвертый Этап',
  '05': 'Пятый Этап',
  '06': 'Таймлайн. Этапы становления энергетической системы России.',
  '07': '2000-е',
  '08': 'Кабинет диспетчера',
  '09': 'Интерактивная витрина',
  '10': 'Карта энергетической системы России',
  '11': 'Структура ЕЭС',
  '12': 'Проекция',
  '14': 'Интерактивный макет',
  '15': 'Альтернативные источники энергии',
  '16': 'Стено-схема',
  '17': 'Игровой зал',
  '18': 'Игровой автомат 1',
  '19': 'Игровой автомат 2',
  '20': '3D модель',
  '21': 'Историческая хроника',
  '22': 'Исторические табло',
  '23': 'Исторический стол диспетчера',
  '24': 'Историческая видеохроника',
}
